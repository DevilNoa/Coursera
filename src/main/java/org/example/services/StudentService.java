...
public class StudentService {
    ...
    public void studentAlter(Connection connection, String id_students, String newFirstName, String newLastName) {
        try {
    ...
    //print student by id
    public void printStudentByID(Connection connection, String id_students) {
        try {
